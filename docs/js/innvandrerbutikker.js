...
(async function () {
  ...
  const SUPPORTED_LANGUAGES = ['nb', 'en', 'sv', 'da', 'fi', 'de', 'nl', 'fr', 'it', 'pt', 'es', 'ko', 'pl', 'ru', 'zh'];
  ...
  function detectPreferredLanguage() {
    ...
    try {
      ...
      const byCountry = { NO: 'nb', SE: 'sv', DK: 'da', FI: 'fi', DE: 'de', NL: 'nl', FR: 'fr', IT: 'it', PT: 'pt', ES: 'es', PL: 'pl', RU: 'ru', CN: 'zh', KR: 'ko' };
