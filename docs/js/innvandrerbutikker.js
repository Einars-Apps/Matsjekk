...
(async function () {
  ...
  // Region/municipality dropdowns list only places present in the loaded dataset.
  const restrictFiltersToDataset = true;
  let activeFiltered = [];
  let filterRunId = 0;
  ...
  const COUNTRY_REGIONS_FALLBACK = {
    ...
    PL: ['Dolnośląskie', 'Kujawsko-Pomorskie', 'Lubelskie', 'Lubuskie', 'Łódźkie', 'Małopolskie', 'Mazowieckie', 'Opolskie', 'Podkarpackie', 'Podlaskie', 'Pomorskie', 'Śląskie', 'Świętokrzyskie', 'Warmińsko-Mazurskie', 'Wielkopolskie', 'Zachodniopomorskie'],
    CZ: ['Praha', 'Středočeský kraj', 'Jihočeský kraj', 'Plzeňský kraj', 'Karlovarský kraj', 'Ústecký kraj', 'Liberecký kraj', 'Královéhradecký kraj', 'Pardubický kraj', 'Kraj Vysočina', 'Jihomoravský kraj', 'Olomoucký kraj', 'Zlínský kraj', 'Moravskoslezský kraj'],
    SK: ['Bratislavský kraj', 'Trnavský kraj', 'Trenčínský kraj', 'Nitrianský kraj', 'Žilinský kraj', 'Banskobystrický kraj', 'Prešovský kraj', 'Košický kraj'],
    HU: ['Budapest', 'Pest', 'Fejér', 'Komárom-Esztergom', 'Veszprém', 'Győr-Moson-Sopron', 'Vas', 'Zala', 'Somogy', 'Tolna', 'Baranya', 'Bács-Kiskun', 'Csongrád-Csanád', 'Békés', 'Hajdú-Bihar', 'Szabolcs-Szatmár-Bereg', 'Jász-Nagykun-Szolnok', 'Nógrád', 'Heves', 'Borsod-Abaúj-Zemplén'],
    RO: ['Nord-Vest', 'Centru', 'Nord-Est', 'Sud-Est', 'Sud-Muntenia', 'București-Ilfov', 'Sud-Vest Oltenia', 'Vest'],
    BG: ['Sofia-grad', 'Plovdiv', 'Varna', 'Burgas', 'Ruse', 'Pleven', 'Stara Zagora', 'Vidin'],
    GR: ['Attica', 'Central Macedonia', 'Thessaly', 'Central Greece', 'Western Greece', 'Peloponnese', 'Ionian Islands', 'North Aegean', 'South Aegean', 'Crete', 'Eastern Macedonia and Thrace', 'Western Macedonia', 'Epirus'],
    HR: ['Grad Zagreb', 'Zagrebačka', 'Splitsko-dalmatinska', 'Primorsko-goranska', 'Osječko-baranjska', 'Brodsko-posavska', 'Varaždinska', 'Sisačko-moslavačka', 'Istarska', 'Karlovačka', 'Zadarska', 'Dubrovačko-neretvanska'],
    SI: ['Pomurska', 'Podravska', 'Koroška', 'Savinjska', 'Zasavska', 'Posavska', 'Jugovzhodna Slovenija', 'Osrednjeslovenska', 'Gorenjska', 'Primorsko-notranjska', 'Goriška', 'Obalno-kraška'],
    EE: ['Harjumaa', 'Tartumaa', 'Ida-Virumaa', 'Pärnumaa', 'Lääne-Virumaa', 'Võrumaa', 'Viljandimaa', 'Raplamaa'],
    LV: ['Rīga', 'Vidzeme', 'Kurzeme', 'Latgale', 'Zemgale', 'Pierīga'],
    LT: ['Vilniaus apskritis', 'Kauno apskritis', 'Klaipėdos apskritis', 'Šiaulių apskritis', 'Panevėžio apskritis', 'Alytaus apskritis', 'Marijampolės apskritis', 'Tauragės apskritis', 'Telšių apskritis', 'Utenos apskritis'],
    IS: ['Höfuðborgarsvæðið', 'Suðurnes', 'Vesturland', 'Vestfirðir', 'Norðurland vestra', 'Norðurland eystra', 'Austurland', 'Suðurland'],
    MT: ['Valletta', 'Birkirkara', 'Mosta', 'Qormi', 'Rabat'],
    ...
    BA: ['Federacija Bosne i Hercegovine', 'Republika Srpska', 'Brčko distrikt'],
    ME: ['Primorje', 'Centralna Crna Gora', 'Sjever', 'Podgorica'],
    MK: ['Skopski', 'Pelagoniski', 'Jugozapaden', 'Jugoistočen', 'Pološki', 'Severoistočen', 'Vardar', 'Istočen'],
    RS: ['Beograd', 'Vojvodina', 'Šumadija i Zapadna Srbija', 'Južna i Istočna Srbija', 'Kosovo i Metohija'],
    MD: ['Chișinău', 'Bălți', 'Ai̇hdar', 'Cahul', 'Tiraspol'],
    UA: ['Kievska oblast', 'Lvivska oblast', 'Kharkivska oblast', 'Odeska oblast', 'Dnipropetrovska oblast', 'Zaporizka oblast', 'Zakarpatska oblast', 'Volynska oblast'],
    GL: ['Sermersooq', 'Qeqqata', 'Avannaata', 'Qeqertalik', 'Kujalleq'],
    US: ['Northeast', 'Mid-Atlantic', 'Southeast', 'Midwest', 'Great Plains', 'Mountain West', 'Pacific Northwest', 'Southwest', 'California', 'Texas', 'Florida', 'New York'],
    ...
    NZ: ['Northland', 'Auckland', 'Waikato', 'Bay of Plenty', 'Wellington', 'Canterbury', 'Otago', 'Southland'],
    BR: ['São Paulo', 'Rio de Janeiro', 'Minas Gerais', 'Bahia', 'Rio Grande do Sul', 'Paraná', 'Santa Catarina', 'Pernambuco'],
    AR: ['Buenos Aires', 'Córdoba', 'Santa Fe', 'Mendoza', 'Tucumán', 'Entre Ríos', 'Salta', 'Misiones'],
    CL: ['Región Metropolitana', 'Biobío', 'Maule', 'Araucanía', 'Los Lagos', 'Valparaíso'],
    CO: ['Cundinamarca', 'Antioquia', 'Valle del Cauca', 'Atlántico', 'Bolívar', 'Santander'],
    PE: ['Lima', 'Arequipa', 'Cusco', 'La Libertad', 'Piura', 'Junín'],
    UY: ['Montevideo', 'Canelones', 'Maldonado', 'Salto', 'Colonia', 'Rivera'],
    PY: ['Central', 'Alto Paraná', 'San Pedro', 'Caaguazú', 'Itapúa', 'Cordillera'],
    VE: ['Distrito Capital', 'Miranda', 'Carabobo', 'Zulia', 'Aragua', 'Bolívar'],
    EC: ['Pichincha', 'Guayas', 'Azuay', 'Manabí', 'El Oro', 'Los Ríos'],
    BO: ['La Paz', 'Santa Cruz', 'Cochabamba', 'Oruro', 'Potosí', 'Chuquisaca'],
  };
  ...
  const COUNTRY_MUNICIPALITIES_FALLBACK = {
    ...
    IS: ['Reykjavík', 'Akureyri', 'Selfoss', 'Akranes', 'Keflavík'],
    MT: ['Valletta', 'Birkirkara', 'Mosta', 'Qormi', 'Rabat'],
    ...
    ME: ['Podgorica', 'Nikšić', 'Bar', 'Bijelo Polje', 'Herceg Novi'],
    MK: ['Skopje', 'Bitola', 'Ohrid', 'Tetovo', 'Kumanovo'],
    RS: ['Beograd', 'Novi Sad', 'Niš', 'Kragujevac', 'Subotica'],
    MD: ['Chișinău', 'Bălți', 'Tiraspol', 'Cahul', 'Ungheni'],
    UA: ['Kyiv', 'Kharkiv', 'Odesa', 'Dnipro', 'Lviv', 'Zaporizhzhia'],
    GL: ['Nuuk', 'Sisimiut', 'Ilulissat', 'Qaqortoq', 'Aasiaat'],
    US: ['New York', 'Los Angeles', 'Chicago', 'Houston', 'Phoenix', 'Philadelphia'],
    CA: ['Toronto', 'Montréal', 'Vancouver', 'Calgary', 'Edmonton', 'Ottawa'],
    AU: ['Sydney', 'Melbourne', 'Brisbane', 'Perth', 'Adelaide', 'Canberra'],
    NZ: ['Auckland', 'Wellington', 'Christchurch', 'Dunedin', 'Hamilton'],
    BR: ['São Paulo', 'Rio de Janeiro', 'Brasília', 'Salvador', 'Fortaleza'],
    AR: ['Buenos Aires', 'Córdoba', 'Rosario', 'Mendoza', 'San Miguel de Tucumán'],
    ...
    BO: ['Sucre', 'La Paz', 'Cochabamba', 'Santa Cruz de la Sierra', 'Oruro'],
  };
  ...
  const COUNTRY_REGION_MUNICIPALITIES_FALLBACK = {
    ...
    PL: {
      'Małopolskie': ['Kraków', 'Nowy Sącz', 'Tarnów', 'Oświęcim', 'Zakopane'],
      'Mazowieckie': ['Warszawa', 'Radom', 'Płock', 'Siedlce', 'Ostrołęka'],
      'Wielkopolskie': ['Poznań', 'Kalisz', 'Konin', 'Piła', 'Gniezno'],
      'Dolnośląskie': ['Wrocław', 'Wałbrzych', 'Legnica', 'Jelenia Góra', 'Lubin'],
      'Śląskie': ['Katowice', 'Częstochowa', 'Sosnowiec', 'Gliwice', 'Zabrze'],
      'Pomorskie': ['Gdańsk', 'Gdynia', 'Sopot', 'Słupsk', 'Starogard Gdański'],
    ...
    CZ: {
      ...
      'Plzeňský kraj': ['Plzeň', 'Klatovy', 'Rokycany', 'Domažlice', 'Stříbro'],
      'Jihočeský kraj': ['České Budějovice', 'Tábor', 'Písek', 'Strakonice', 'Jindřichův Hradec'],
    },
    SK: {
      'Bratislavský kraj': ['Bratislava', 'Senec', 'Pezinok', 'Malacky', 'Stupava'],
      'Košický kraj': ['Košice', 'Spišská Nová Ves', 'Rožňava', 'Gelnica', 'Michalovce'],
      'Žilinský kraj': ['Žilina', 'Martin', 'Liptovský Mikuláš', 'Ružomberok', 'Čadca'],
      'Prešovský kraj': ['Prešov', 'Poprad', 'Spišská Nová Ves', 'Stará Ľubovňa', 'Bardejov'],
    },
    HU: {
      'Budapest': ['Budapest'],
      'Pest': ['Érd', 'Vác', 'Szentendre', 'Gödöllő', 'Dunakeszi'],
      'Győr-Moson-Sopron': ['Győr', 'Sopron', 'Mosonmagyaróvár', 'Kapuvár', 'Csorna'],
      'Hajdú-Bihar': ['Debrecen', 'Hajdúszoboszló', 'Berettyóújfalu', 'Hajdúböszörmény'],
      'Baranya': ['Pécs', 'Mohács', 'Komló', 'Szigetvár', 'Siklós'],
      'Csongrád-Csanád': ['Szeged', 'Hódmezővásárhely', 'Szentes', 'Makó', 'Csongrád'],
    },
    GR: {
      'Attica': ['Athens', 'Piraeus', 'Peristeri', 'Kallithea', 'Nikaia'],
      'Central Macedonia': ['Thessaloniki', 'Serres', 'Katerini', 'Veria', 'Kilkis'],
      'Thessaly': ['Larissa', 'Volos', 'Trikala', 'Karditsa', 'Tyrnavos'],
      'Crete': ['Heraklion', 'Chania', 'Rethymno', 'Agios Nikolaos', 'Ierapetra'],
      'Peloponnese': ['Patras', 'Kalamata', 'Tripoli', 'Corinth', 'Nafplio'],
    },
    HR: {
      'Grad Zagreb': ['Zagreb'],
      'Splitsko-dalmatinska': ['Split', 'Sinj', 'Makarska', 'Omiš', 'Trogir'],
      'Primorsko-goranska': ['Rijeka', 'Opatija', 'Crikvenica', 'Mali Lošinj', 'Krk'],
      'Osječko-baranjska': ['Osijek', 'Đakovo', 'Beli Manastir', 'Valpovo', 'Našice'],
      'Istarska': ['Pula', 'Rovinj', 'Poreč', 'Labin', 'Umag'],
    },
    US: {
      'Northeast': ['Boston', 'Providence', 'Hartford', 'Portland', 'Burlington'],
      'Mid-Atlantic': ['New York', 'Philadelphia', 'Baltimore', 'Pittsburgh', 'Albany'],
      'Southeast': ['Atlanta', 'Miami', 'Charlotte', 'Raleigh', 'Nashville'],
      'Midwest': ['Chicago', 'Columbus', 'Indianapolis', 'Kansas City', 'Milwaukee'],
    ...
    AU: {
      ...
      'Victoria': ['Melbourne', 'Geelong', 'Bendigo', 'Ballarat', 'Shepparton'],
    ...
    NZ: {
      ...
      'Canterbury': ['Christchurch', 'Timaru', 'Ashburton', 'Kaikōura', 'Hurunui'],
      'Otago': ['Dunedin', 'Queenstown', 'Wānaka', 'Oamaru', 'Alexandra'],
    },
  };
  ...
  const countryAliases = {
    ...
    grønland: 'GL', gronland: 'GL', greenland: 'GL',
  ...
  const PAGE_TRANSLATIONS = {
    ...
    fr: {
      ...
      pageTitle: '\u00c9piceries immigrantes',
      introText: 'Trouvez des magasins qui importent des produits d\'autres pays et traditions. Filtrez par pays \u2192 r\u00e9gion \u2192 commune, recherchez des produits et planifiez vos itin\u00e9raires.',
      topHomeTab: 'Accueil',
      ...
      resultsHeadingDefault: '\u00c9piceries immigrantes pr\u00e8s de chez vous',
      nearbyHeadingPrefix: '\u00c9piceries immigrantes pr\u00e8s de chez vous',
      suggestionHeading: 'Sugg\u00e9rer un lieu manquant',
      suggestionIntro: 'Un magasin manque\u00a0? Envoyez le nom, la commune et le pays pour mod\u00e9ration.',
      ...
      suggestNamePlaceholder: 'Ex. Magasin Solheim',
      ...
      reportNamePlaceholder: 'Ex. \u00c9picerie 12345',
      ...
      quickReportDefaultReason: 'Ne semble pas \u00eatre une vraie \u00e9picerie immigrante.',
    },
    de: {
      ...
      resultsHeadingDefault: 'Einwandererl\u00e4den in Ihrer N\u00e4he',
      nearbyHeadingPrefix: 'Einwandererl\u00e4den in Ihrer N\u00e4he',
      suggestionHeading: 'Fehlenden Ort vorschlagen',
      suggestionIntro: 'Fehlt ein Einwandererladen? Name, Gemeinde und Land zur Moderation einsenden.',
      suggestNameLabel: 'Name',
      suggestMunicipalityLabel: 'Gemeinde',
      suggestCountryLabel: 'Land',
      suggestAddressLabel: 'Adresse (empfohlen)',
      suggestWebsiteLabel: 'Webseite (empfohlen)',
      suggestNamePlaceholder: 'Z.B. Laden Solheim',
      ...
      reportNamePlaceholder: 'Z.B. Einwandererladen 12345',
      ...
      quickReportDefaultReason: 'Scheint kein echter Einwandererladen zu sein.',
    },
    sv: {
      languageLabel: 'Spr\u00e5k',
      pageTitle: 'Invandringsbutiker',
      introText: 'Hitta butiker som importerar varor fr\u00e5n andra l\u00e4nder och traditioner. Filtrera efter land \u2192 region \u2192 kommun, s\u00f6k produkter och planera resor.',
      topHomeTab: 'Hem',
      ...
      resultsHeadingDefault: 'Invandringsbutiker n\u00e4ra dig',
      nearbyHeadingPrefix: 'Invandringsbutiker n\u00e4ra dig',
      suggestionHeading: 'F\u00f6resl\u00e5 en plats som saknas',
      suggestionIntro: 'Saknas en invandringsbutik? Skicka in namn, kommun och land f\u00f6r moderering.',
      ...
      suggestNamePlaceholder: 'T.ex. Butik Solheim',
      ...
      reportNamePlaceholder: 'T.ex. Invandringsbutik 12345',
      ...
      quickReportDefaultReason: 'Verkar inte vara en riktig invandringsbutik.',
    },
    da: {
      languageLabel: 'Sprog',
      pageTitle: 'Indvandrerbutikker',
      introText: 'Find butikker der importerer varer fra andre lande og traditioner. Filtrer efter land \u2192 region \u2192 kommune, s\u00f8g produkter og planl\u00e6g ruter.',
      topHomeTab: 'Hjem',
      topFarmshopsTab: 'G\u00e5rdsbutikker',
      topOrganicTab: '\u00d8kologiske g\u00e5rdsbutikker',
      ...
      resultsHeadingDefault: 'Indvandrerbutikker n\u00e6r dig',
      nearbyHeadingPrefix: 'Indvandrerbutikker n\u00e6r dig',
      suggestionHeading: 'Foresl\u00e5 et manglende sted',
      suggestionIntro: 'Mangler der en indvandrerbutik? Indsend navn, kommune og land til moderering.',
      suggestNameLabel: 'Navn',
      suggestMunicipalityLabel: 'Kommune',
      suggestCountryLabel: 'Land',
      suggestAddressLabel: 'Adresse (anbefalet)',
      suggestWebsiteLabel: 'Hjemmeside (anbefalet)',
      suggestNamePlaceholder: 'F.eks. Butik Solheim',
      suggestMunicipalityPlaceholder: 'F.eks. Asker',
      ...
      reportNamePlaceholder: 'F.eks. Indvandrerbutik 12345',
      ...
      quickReportBtn: 'Rapporter',
      quickReportDefaultReason: 'Ser ikke ud til at v\u00e6re en rigtig indvandrerbutik.',
    },
    fi: {
      languageLabel: 'Kieli',
      pageTitle: 'Maahanmuuttajakaupat',
      introText: 'L\u00f6yd\u00e4 kauppoja, jotka tuovat tuotteita muista maista ja perinteist\u00e4. Suodata maan \u2192 alueen \u2192 kunnan mukaan, etsi tuotteita ja suunnittele reittej\u00e4.',
      topHomeTab: 'Koti',
      ...
      resultsHeadingDefault: 'Maahanmuuttajakaupat l\u00e4hell\u00e4 sinua',
      nearbyHeadingPrefix: 'Maahanmuuttajakaupat l\u00e4hell\u00e4 sinua',
      suggestionHeading: 'Ehdota puuttuvaa paikkaa',
      suggestionIntro: 'Puuttuuko maahanmuuttajakauppa? L\u00e4het\u00e4 nimi, kunta ja maa moderointia varten.',
      ...
      suggestNamePlaceholder: 'Esim. Kauppa Solheim',
      ...
      reportNamePlaceholder: 'Esim. Maahanmuuttajakauppa 12345',
      ...
      quickReportDefaultReason: 'Ei vaikuta oikealta maahanmuuttajakaupalta.',
    },
    nl: {
      languageLabel: 'Taal',
      pageTitle: 'Immigrantenwinkels',
      introText: 'Vind winkels die goederen importeren uit andere landen en tradities. Filter op land \u2192 regio \u2192 gemeente, zoek producten en plan routes.',
      ...
      resultsHeadingDefault: 'Immigrantenwinkels bij u in de buurt',
      nearbyHeadingPrefix: 'Immigrantenwinkels bij u in de buurt',
      suggestionHeading: 'Ontbrekende plek voorstellen',
      suggestionIntro: 'Mist u een immigrantenwinkel? Stuur naam, gemeente en land ter moderatie in.',
      ...
      suggestNamePlaceholder: 'Bijv. Winkel Solheim',
      ...
      reportNamePlaceholder: 'Bijv. Immigrantenwinkel 12345',
      ...
      quickReportBtn: 'Melden',
      quickReportDefaultReason: 'Lijkt geen echte immigrantenwinkel te zijn.',
    },
    it: {
      languageLabel: 'Lingua',
      pageTitle: 'Negozi Immigranti',
      introText: 'Trova negozi che importano prodotti da altri paesi e tradizioni. Filtra per paese \u2192 regione \u2192 comune, cerca prodotti e pianifica percorsi.',
      topHomeTab: 'Home',
      ...
      resultsHeadingDefault: 'Negozi immigranti vicino a te',
      nearbyHeadingPrefix: 'Negozi immigranti vicino a te',
      suggestionHeading: 'Suggerisci un luogo mancante',
      suggestionIntro: 'Manca un negozio immigrante? Invia nome, comune e paese per la moderazione.',
      ...
      suggestNamePlaceholder: 'Es. Negozio Solheim',
      ...
      reportNamePlaceholder: 'Es. Negozio 12345',
      ...
      quickReportDefaultReason: 'Non sembra essere un vero negozio immigrante.',
    },
    pt: {
      languageLabel: 'Idioma',
      pageTitle: 'Lojas de Imigrantes',
      introText: 'Encontre lojas que importam produtos de outros pa\u00edses e tradi\u00e7\u00f5es. Filtre por pa\u00eds \u2192 regi\u00e3o \u2192 munic\u00edpio, pesquise produtos e planeie rotas.',
      topHomeTab: 'In\u00edcio',
      ...
      resultsHeadingDefault: 'Lojas de imigrantes perto de si',
      nearbyHeadingPrefix: 'Lojas de imigrantes perto de si',
      suggestionHeading: 'Sugerir um lugar em falta',
      suggestionIntro: 'Falta uma loja de imigrantes? Envie o nome, munic\u00edpio e pa\u00eds para modera\u00e7\u00e3o.',
      suggestNameLabel: 'Nome',
      ...
      suggestNamePlaceholder: 'Ex. Loja Solheim',
      suggestMunicipalityPlaceholder: 'Ex. Asker',
      ...
      reportNamePlaceholder: 'Ex. Loja de imigrantes 12345',
      reportReasonPlaceholder: 'Breve motivo',
      ...
      quickReportDefaultReason: 'N\u00e3o parece ser uma loja de imigrantes real.',
    },
    es: {
      languageLabel: 'Idioma',
      pageTitle: 'Tiendas de Inmigrantes',
      introText: 'Encuentra tiendas que importan productos de otros pa\u00edses y tradiciones. Filtra por pa\u00eds \u2192 regi\u00f3n \u2192 municipio, busca productos y planifica rutas.',
      topHomeTab: 'Inicio',
      ...
      resultsHeadingDefault: 'Tiendas de inmigrantes cerca de ti',
      nearbyHeadingPrefix: 'Tiendas de inmigrantes cerca de ti',
      suggestionHeading: 'Sugerir un lugar que falta',
      suggestionIntro: '\u00bfFalta una tienda de inmigrantes? Env\u00eda nombre, municipio y pa\u00eds para moderaci\u00f3n.',
      ...
      suggestNamePlaceholder: 'P.ej. Tienda Solheim',
      ...
      reportNamePlaceholder: 'P.ej. Tienda de inmigrantes 12345',
      reportReasonPlaceholder: 'Breve motivo',
      ...
      quickReportBtn: 'Reportar',
      quickReportDefaultReason: 'No parece ser una tienda de inmigrantes real.',
    },
    ko: {
      languageLabel: '언어',
      pageTitle: '이민자 상점',
      introText: '다른 나라와 문화의 상품을 수입하는 상점을 찾아보세요. 국가 → 주/지역 → 시군구로 필터링하고, 제품을 검색하며 경로를 계획하세요.',
      topHomeTab: '홈',
      ...
      resultsHeadingDefault: '내 근처 이민자 상점',
      nearbyHeadingPrefix: '내 근처 이민자 상점',
      suggestionHeading: '누락된 장소 제안',
      suggestionIntro: '이민자 상점이 없나요? 검토를 위해 이름, 시군구, 국가를 제출하세요.',
      suggestNameLabel: '이름',
      suggestMunicipalityLabel: '시군구',
      suggestCountryLabel: '국가',
      suggestAddressLabel: '주소 (권장)',
      suggestWebsiteLabel: '웹사이트 (권장)',
      suggestNamePlaceholder: '예: 솔하임 상점',
      ...
      reportNamePlaceholder: '예: 이민자 상점 12345',
      ...
      quickReportBtn: '신고',
      quickReportDefaultReason: '실제 이민자 상점처럼 보이지 않습니다.',
    },
    pl: {
      languageLabel: 'Język',
      pageTitle: 'Sklepy imigrantów',
      introText: 'Znajdź sklepy importujące towary z innych krajów i tradycji. Filtruj według kraju → województwa/regionu → gminy, szukaj produktów i planuj trasy.',
      ...
      resultsHeadingDefault: 'Sklepy imigrantów w pobliżu',
      nearbyHeadingPrefix: 'Sklepy imigrantów w pobliżu',
      suggestionHeading: 'Zaproponuj brakujące miejsce',
      suggestionIntro: 'Brakuje sklepu imigrantów? Wyślij nazwę, gminę i kraj do moderacji.',
      ...
      suggestNamePlaceholder: 'Np. Sklep imigrantów',
      ...
      reportNamePlaceholder: 'Np. Sklep imigrantów 12345',
      ...
      quickReportDefaultReason: 'Nie wygląda na prawdziwy sklep imigrantów.',
    },
    ru: {
      languageLabel: 'Язык',
      pageTitle: 'Магазины иммигрантов',
      introText: 'Найдите магазины, импортирующие товары из других стран и традиций. Фильтруйте по стране → региону → муниципалитету, ищите продукты и планируйте маршруты.',
      topHomeTab: 'Главная',
      ...
      resultsHeadingDefault: 'Магазины иммигрантов рядом с вами',
      nearbyHeadingPrefix: 'Магазины иммигрантов рядом с вами',
      suggestionHeading: 'Предложить отсутствующее место',
      suggestionIntro: 'Нет магазина иммигрантов? Отправьте название, муниципалитет и страну на модерацию.',
      ...
      suggestNamePlaceholder: 'Напр. Магазин Солнечный',
      ...
      reportNamePlaceholder: 'Напр. Магазин иммигрантов 12345',
      ...
      quickReportDefaultReason: 'Не похоже на настоящий магазин иммигрантов.',
    },
    zh: {
      languageLabel: '语言',
      pageTitle: '移民商店',
      introText: '查找进口其他国家和文化商品的商店。按国家 → 县/地区 → 市过滤，搜索产品并规划路线。',
      topHomeTab: '首页',
      ...
      reportNamePlaceholder: '例如 移民商店 12345',
      ...
      quickReportBtn: '举报',
      quickReportDefaultReason: '看起来不像真正的移民商店。',
    },
    ar: {
      languageLabel: 'اللغة',
      pageTitle: 'متاجر المهاجرين',
      introText: 'ابحث عن المتاجر التي تستورد البضائع من دول وتقاليد أخرى. صفّ حسب الدولة ← المنطقة ← البلدية، وابحث عن المنتجات وخطط للرحلات.',
      topHomeTab: 'الرئيسية',
      ...
      resultsHeadingDefault: 'متاجر المهاجرين بالقرب منك',
      nearbyHeadingPrefix: 'متاجر المهاجرين بالقرب منك',
      suggestionHeading: 'اقتراح مكان مفقود',
      suggestionIntro: 'هل تفتقد متجر مهاجرين؟ أرسل الاسم والبلدية والدولة للمراجعة.',
      ...
      suggestNamePlaceholder: 'مثال: متجر سولهايم',
      ...
      reportNamePlaceholder: 'مثال: متجر مهاجرين 12345',
      ...
      quickReportDefaultReason: 'لا يبدو أنه متجر مهاجرين حقيقي.',
    },
    th: {
      languageLabel: 'ภาษา',
      pageTitle: 'ร้านผู้อพยพ',
      introText: 'ค้นหาร้านที่นำเข้าสินค้าจากประเทศและวัฒนธรรมอื่นๆ กรองตามประเทศ → จังหวัด/ภูมิภาค → เขต ค้นหาสินค้า และวางแผนเส้นทาง',
      topHomeTab: 'หน้าหลัก',
      ...
      resultsHeadingDefault: 'ร้านผู้อพยพใกล้คุณ',
      nearbyHeadingPrefix: 'ร้านผู้อพยพใกล้คุณ',
      suggestionHeading: 'แนะนำสถานที่ที่หายไป',
      suggestionIntro: 'ไม่มีร้านผู้อพยพ? ส่งชื่อ เขต และประเทศเพื่อการตรวจสอบ',
      ...
      suggestNamePlaceholder: 'เช่น ร้านซอลไฮม์',
      ...
      reportNamePlaceholder: 'เช่น ร้านผู้อพยพ 12345',
      ...
      quickReportDefaultReason: 'ดูเหมือนไม่ใช่ร้านผู้อพยพจริง',
    },
  };
