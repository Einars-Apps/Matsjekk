...
(async function () {
  ...
  const WEST_EUROPE = [
    ...
    { code: 'BA', name: 'Bosnia og Hercegovina' },
    { code: 'BR', name: 'Brasil' },
  ...
  const COUNTRY_REGIONS_FALLBACK = {
    ...
    HR: ['Grad Zagreb', 'Zagrebačka', 'Splitsko-dalmatinska', 'Primorsko-goranska', 'Osječko-baranjska', 'Brodsko-posavska', 'Varaždinska', 'Sisačko-moslavačka', 'Istarska', 'Karlovačka', 'Zadarska', 'Vukovarsko-srijemska', 'Dubrovačko-neretvanska', 'Koprivničko-križevačka', 'Bjelovarsko-bilogorska', 'Šibensko-kninska', 'Virovitičko-podravska', 'Požeško-slavonska', 'Ličko-senjska', 'Međimurska', 'Krapinsko-zagorska'],
    ...
    CA: ['Ontario', 'Quebec', 'British Columbia', 'Alberta', 'Manitoba', 'Saskatchewan', 'Nova Scotia', 'New Brunswick', 'Newfoundland and Labrador', 'Prince Edward Island', 'Northwest Territories', 'Yukon', 'Nunavut'],
    ...
    BR: ['São Paulo', 'Rio de Janeiro', 'Minas Gerais', 'Bahia', 'Rio Grande do Sul', 'Paraná', 'Santa Catarina', 'Pernambuco', 'Goiás', 'Ceará'],
    AR: ['Buenos Aires', 'Córdoba', 'Santa Fe', 'Mendoza', 'Tucumán', 'Entre Ríos', 'Salta', 'Misiones', 'Chaco', 'Corrientes'],
    CL: ['Región Metropolitana', 'Biobío', 'Maule', 'Araucanía', 'Los Lagos', 'Valparaíso', "O'Higgins", 'Los Ríos', 'Coquimbo', 'Atacama'],
    CO: ['Cundinamarca', 'Antioquia', 'Valle del Cauca', 'Atlántico', 'Bolívar', 'Santander', 'Nariño', 'Córdoba', 'Cauca', 'Tolima'],
    PE: ['Lima', 'Arequipa', 'Cusco', 'La Libertad', 'Piura', 'Junín', 'Lambayeque', 'Puno', 'Ica', 'Cajamarca'],
    UY: ['Montevideo', 'Canelones', 'Maldonado', 'Salto', 'Colonia', 'Rivera', 'Paysandú', 'Artigas', 'Rocha', 'Tacuarembó'],
    PY: ['Central', 'Alto Paraná', 'San Pedro', 'Caaguazú', 'Itapúa', 'Cordillera', 'Guairá', 'Misiones', 'Caazapá', 'Ñeembucú'],
    VE: ['Distrito Capital', 'Miranda', 'Carabobo', 'Zulia', 'Aragua', 'Bolívar', 'Anzoátegui', 'Mérida', 'Lara', 'Táchira'],
    EC: ['Pichincha', 'Guayas', 'Azuay', 'Manabí', 'El Oro', 'Los Ríos', 'Tungurahua', 'Chimborazo', 'Imbabura', 'Esmeraldas'],
    BO: ['La Paz', 'Santa Cruz', 'Cochabamba', 'Oruro', 'Potosí', 'Chuquisaca', 'Tarija', 'Beni', 'Pando'],
  };
  ...
  const COUNTRY_REGION_MUNICIPALITIES_FALLBACK = {
    ...
    IS: {
      'Höfuðborgarsvæðið': ['Reykjavík', 'Kópavogur', 'Hafnarfjörður', 'Reykjanesbær', 'Garðabær'],
      'Suðurnes': ['Reykjanesbær', 'Sandgerði', 'Grindavík', 'Garður', 'Vogar'],
      'Vesturland': ['Akranes', 'Borgarnes', 'Stykkishólmur', 'Búðardalur', 'Grundarfjörður'],
      'Vestfirðir': ['Ísafjörður', 'Bolungarvík', 'Þingeyri', 'Flateyri', 'Patreksfjörður'],
      'Norðurland vestra': ['Sauðárkrókur', 'Blönduós', 'Varmahlíð', 'Hvammstangi'],
      'Norðurland eystra': ['Akureyri', 'Húsavík', 'Dalvík', 'Siglufjörður', 'Ólafsfjörður'],
      'Austurland': ['Egilsstaðir', 'Höfn', 'Neskaupstaður', 'Eskifjörður', 'Vopnafjörður'],
      'Suðurland': ['Selfoss', 'Hvolsvöllur', 'Vestmannaeyjar', 'Hveragerði', 'Flúðir'],
    },
    PL: {
      ...
      'Łódźkie': ['Łódź', 'Piotrków Trybunalski', 'Pabianice', 'Tomaszów Mazowiecki', 'Zgierz'],
      'Podkarpackie': ['Rzeszów', 'Przemyśl', 'Stalowa Wola', 'Tarnobrzeg', 'Krosno'],
      'Podlaskie': ['Białystok', 'Łomża', 'Suwałki', 'Bielsk Podlaski', 'Hajnówka'],
      'Warmińsko-Mazurskie': ['Olsztyn', 'Elbląg', 'Ełk', 'Ostróda', 'Kętrzyn'],
      'Zachodniopomorskie': ['Szczecin', 'Koszalin', 'Stargard', 'Świnoujście', 'Kołobrzeg'],
    },
    CZ: {
      'Praha': ['Praha'],
      ...
      'Zlínský kraj': ['Zlín', 'Uherské Hradiště', 'Kroměříž', 'Vsetín', 'Otrokovice'],
    },
    SK: {
      'Bratislavský kraj': ['Bratislava', 'Senec', 'Pezinok', 'Malacky', 'Stupava'],
      'Trnavský kraj': ['Trnava', 'Dunajská Streda', 'Hlohovec', 'Galanta', 'Senica'],
      'Trenčínský kraj': ['Trenčín', 'Považská Bystrica', 'Prievidza', 'Nové Mesto nad Váhom'],
      'Nitrianský kraj': ['Nitra', 'Komárno', 'Nové Zámky', 'Šaľa', 'Topoľčany'],
    ...
    HU: {
      'Budapest': ['Budapest'],
      'Pest': ['Érd', 'Eger', 'Vác', 'Szentendre', 'Gödöllő'],
      ...
      'Borsod-Abaúj-Zemplén': ['Miskolc', 'Kazincbarcika', 'Tiszaújváros', 'Ózd', 'Sátoraljaújhely'],
      'Baranya': ['Pécs', 'Mohács', 'Komló', 'Szigetvár', 'Siklós'],
      'Csongrád-Csanád': ['Szeged', 'Hódmezővásárhely', 'Szentes', 'Makó', 'Csongrád'],
      'Vas': ['Szombathely', 'Körmend', 'Sárvár', 'Kőszeg', 'Celldömölk'],
    },
    RO: {
      'Nord-Vest': ['Cluj-Napoca', 'Oradea', 'Baia Mare', 'Bistrița', 'Satu Mare'],
      'Centru': ['Brașov', 'Sibiu', 'Târgu Mureș', 'Alba Iulia', 'Sfântu Gheorghe'],
      'Nord-Est': ['Iași', 'Bacău', 'Suceava', 'Piatra Neamț', 'Botoșani'],
      'Sud-Est': ['Constanța', 'Galați', 'Brăila', 'Buzău', 'Focșani'],
      'Sud-Muntenia': ['Ploiești', 'Alexandria', 'Târgoviște', 'Câmpulung', 'Pitești'],
      'București-Ilfov': ['București', 'Voluntari', 'Pantelimon'],
      'Sud-Vest Oltenia': ['Craiova', 'Râmnicu Vâlcea', 'Pitești', 'Drobeta-Turnu Severin', 'Slatina'],
      'Vest': ['Timișoara', 'Arad', 'Deva', 'Lugoj', 'Reșița'],
    },
    HR: {
      'Grad Zagreb': ['Zagreb'],
      ...
      'Dubrovačko-neretvanska': ['Dubrovnik', 'Metković', 'Ploče', 'Korčula', 'Opuzen'],
      'Zadarska': ['Zadar', 'Biograd na Moru', 'Benkovac', 'Obrovac', 'Nin'],
      'Varaždinska': ['Varaždin', 'Ludbreg', 'Ivanec', 'Lepoglava', 'Novi Marof'],
    },
    SI: {
      'Osrednjeslovenska': ['Ljubljana', 'Domžale', 'Kamnik', 'Grosuplje', 'Vrhnika'],
      'Podravska': ['Maribor', 'Ptuj', 'Slovenska Bistrica', 'Ormož', 'Lenart'],
      'Savinjska': ['Celje', 'Velenje', 'Laško', 'Mozirje', 'Žalec'],
      'Gorenjska': ['Kranj', 'Jesenice', 'Tržič', 'Radovljica', 'Škofja Loka'],
      'Obalno-kraška': ['Koper', 'Piran', 'Izola', 'Portorož', 'Sežana'],
      'Goriška': ['Nova Gorica', 'Šempeter-Vrtojba', 'Ajdovščina', 'Tolmin', 'Idrija'],
      'Jugovzhodna Slovenija': ['Novo Mesto', 'Kočevje', 'Trebnje', 'Črnomelj', 'Metlika'],
      'Pomurska': ['Murska Sobota', 'Lendava', 'Ljutomer', 'Gornja Radgona', 'Moravske Toplice'],
    },
    GR: {
      ...
      'Western Greece': ['Patras', 'Agrinio', 'Messolonghi', 'Pyrgos', 'Aigio'],
      'Epirus': ['Ioannina', 'Preveza', 'Arta', 'Thesprotia'],
      'Ionian Islands': ['Corfu', 'Lefkada', 'Zakynthos', 'Kefalonia', 'Ithaca'],
    },
    US: {
      ...
      'Great Plains': ['Minneapolis', 'Omaha', 'Sioux Falls', 'Lincoln', 'Fargo'],
      'Mountain West': ['Denver', 'Salt Lake City', 'Albuquerque', 'Boise', 'Helena'],
      'Pacific Northwest': ['Seattle', 'Portland', 'Spokane', 'Olympia', 'Bellingham'],
      'Southwest': ['Houston', 'San Antonio', 'Dallas', 'Austin', 'El Paso'],
    ...
    AU: {
      ...
      'South Australia': ['Adelaide', 'Mount Gambier', 'Gawler', 'Whyalla', 'Port Augusta'],
    ...
    NZ: {
      ...
      'Waikato': ['Hamilton', 'Cambridge', 'Te Awamutu', 'Tokoroa', 'Raglan'],
      'Bay of Plenty': ['Tauranga', 'Whakatāne', 'Rotorua', 'Ōpōtiki', 'Kawerau'],
      'Otago': ['Dunedin', 'Queenstown', 'Wānaka', 'Oamaru', 'Alexandra'],
      'Southland': ['Invercargill', 'Gore', 'Te Anau', 'Winton'],
      'Manawatū-Whanganui': ['Palmerston North', 'Whanganui', 'Levin', 'Feilding', 'Dannevirke'],
    },
  };
  ...
  const countryAliases = {
    ...
    pl: 'PL', polen: 'PL', poland: 'PL', polska: 'PL',
    cz: 'CZ', tsjekkia: 'CZ', tjekkia: 'CZ', czechrepublic: 'CZ', czechia: 'CZ',
    sk: 'SK', slovakiet: 'SK', slovensko: 'SK',
    hu: 'HU', ungarn: 'HU', hungary: 'HU',
    ro: 'RO', romania: 'RO',
    bg: 'BG', bulgaria: 'BG',
    estland: 'EE', estonia: 'EE', eesti: 'EE',
    latvia: 'LV', latvija: 'LV',
    litauen: 'LT', lithuania: 'LT', lietuva: 'LT',
    kroatia: 'HR', croatia: 'HR', hrvatska: 'HR',
    slovenia: 'SI', slovenija: 'SI',
    serbia: 'RS', srbija: 'RS',
    bosniaandhercegovina: 'BA', bosniaandherzegovina: 'BA', bosnahercegovina: 'BA',
    crnaGora: 'ME', crngora: 'ME', montenegro: 'ME',
    nordmakEdonia: 'MK', northmacedonia: 'MK', makedonija: 'MK',
  ...
  function getCountrySearchLexicon(countryCode) {
    ...
    const lexiconByCountry = {
      ...
      PL: {
        baseTerm: 'sklep rolniczy sprzedaż bezpośrednia',
        outletTerms: ['"sklep rolniczy"', '"sprzedaż bezpośrednia"', '"produkty lokalne"', '"farm shop"'],
        signalTerms: ['oficjalna strona', 'adres', 'godziny otwarcia', 'kontakt'],
        negativeTerms: ['-przepis', '-restauracja', '-hotel', '-wikipedia'],
      },
      CZ: {
        baseTerm: 'farmářský obchod přímý prodej',
        outletTerms: ['"farmářský obchod"', '"přímý prodej"', '"farmářské produkty"', '"farm shop"'],
        signalTerms: ['oficiální web', 'adresa', 'otevírací doba', 'kontakt'],
        negativeTerms: ['-recept', '-restaurace', '-hotel', '-wikipedia'],
      },
      SK: {
        baseTerm: 'farmársky obchod priamy predaj',
        outletTerms: ['"farmársky obchod"', '"priamy predaj"', '"farmárske produkty"', '"farm shop"'],
        signalTerms: ['oficiálna stránka', 'adresa', 'otváracie hodiny', 'kontakt'],
        negativeTerms: ['-recept', '-reštaurácia', '-hotel', '-wikipedia'],
      },
      HU: {
        baseTerm: 'gazdasági bolt közvetlen értékesítés',
        outletTerms: ['"gazdasági bolt"', '"közvetlen értékesítés"', '"helyi termékek"', '"farm shop"'],
        signalTerms: ['hivatalos weboldal', 'cím', 'nyitvatartás', 'kapcsolat'],
        negativeTerms: ['-recept', '-étterem', '-hotel', '-wikipedia'],
      },
      RO: {
        baseTerm: 'magazin fermă vânzare directă',
        outletTerms: ['"magazin fermă"', '"vânzare directă"', '"produse locale"', '"farm shop"'],
        signalTerms: ['site oficial', 'adresă', 'program', 'contact'],
        negativeTerms: ['-rețetă', '-restaurant', '-hotel', '-wikipedia'],
      },
      HR: {
        baseTerm: 'seoska prodavaonica izravna prodaja',
        outletTerms: ['"seoska prodavaonica"', '"izravna prodaja"', '"lokalni proizvodi"', '"farm shop"'],
        signalTerms: ['službena stranica', 'adresa', 'radno vrijeme', 'kontakt'],
        negativeTerms: ['-recept', '-restoran', '-hotel', '-wikipedia'],
      },
      GR: {
        baseTerm: 'αγροτικό κατάστημα απευθείας πώληση',
        outletTerms: ['"αγροτικό κατάστημα"', '"απευθείας πώληση"', '"τοπικά προϊόντα"', '"farm shop"'],
        signalTerms: ['επίσημη ιστοσελίδα', 'διεύθυνση', 'ώρες λειτουργίας', 'επικοινωνία'],
        negativeTerms: ['-συνταγή', '-εστιατόριο', '-ξενοδοχείο', '-wikipedia'],
      },
      US: {
        baseTerm: 'farm stand farm market local produce',
        outletTerms: ['"farm stand"', '"farm market"', '"farm store"', '"local produce"', '"farmers market"'],
        signalTerms: ['official website', 'address', 'hours', 'contact'],
        negativeTerms: ['-recipe', '-restaurant', '-hotel', '-wikipedia'],
      },
      CA: {
        baseTerm: 'farm store local produce marché fermier',
        outletTerms: ['"farm store"', '"farm market"', '"local produce"', '"marché fermier"'],
        signalTerms: ['official website', 'address', 'hours', 'contact'],
        negativeTerms: ['-recipe', '-restaurant', '-hotel', '-wikipedia'],
      },
      AU: {
        baseTerm: 'farm gate farm shop local produce',
        outletTerms: ['"farm gate"', '"farm shop"', '"farm store"', '"local produce"'],
        signalTerms: ['official website', 'address', 'trading hours', 'contact'],
        negativeTerms: ['-recipe', '-restaurant', '-hotel', '-wikipedia'],
      },
      NZ: {
        baseTerm: 'farm gate farm shop local produce',
      ...
      BR: {
        baseTerm: 'loja da fazenda venda direta produtos locais',
        outletTerms: ['"loja da fazenda"', '"venda direta"', '"produtos locais"', '"feira do produtor"'],
        signalTerms: ['site oficial', 'endereço', 'horário', 'contato'],
        negativeTerms: ['-receita', '-restaurante', '-hotel', '-wikipedia'],
      },
      AR: {
        baseTerm: 'granja tienda local venta directa',
        outletTerms: ['"granja"', '"tienda de campo"', '"venta directa"', '"productos locales"'],
        signalTerms: ['sitio oficial', 'dirección', 'horario', 'contacto'],
        negativeTerms: ['-receta', '-restaurante', '-hotel', '-wikipedia'],
      },
    };
...
out center tags 150;
  ...
  async function findAlongRoute(from, to) {
    ...
    setMapStatus(`Viser ${filtered.length} gårdsbutikker innen ${bufferKm} km av ruten.`);

    if (mapProvider === 'leaflet') {
      leafletBufferLayer = L.geoJSON(buffer, { style: { color: '#00f', weight: 1, opacity: 0.12 } }).addTo(map);
      setTimeout(() => {
        if (leafletBufferLayer) {
          map.removeLayer(leafletBufferLayer);
          leafletBufferLayer = null;
